...
')(?=[^0-9a-zA-Z@]|$))'));
  ...
  twttr.txt.autoLinkEntities = function(text, entities, options) {
    ...
    options.hashtagUrlBase = options.hashtagUrlBase || "http://socialnode.dev/search?q=%23";
    options.cashtagClass = options.cashtagClass || DEFAULT_CASHTAG_CLASS;
    options.cashtagUrlBase = options.cashtagUrlBase || "http://socialnode.dev/search?q=%24";
    options.listClass = options.listClass || DEFAULT_LIST_CLASS;
    options.usernameClass = options.usernameClass || DEFAULT_USERNAME_CLASS;
    options.usernameUrlBase = options.usernameUrlBase || "http://socialnode.dev/";
    options.listUrlBase = options.listUrlBase || "http://socialnode.dev/";
